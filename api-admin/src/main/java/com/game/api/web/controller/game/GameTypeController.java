...
public class GameTypeController {
    @Autowired
    private GameTypeService gameThemeService;
    ...
    @PostMapping
    @ApiOperation("新增")
    public BaseResponse insert(@RequestBody GameType gameTheme) {
    ...
    @PutMapping
    @ApiOperation("修改")
    public BaseResponse update(@RequestBody GameType gameTheme) {
